  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "sf-c-primary": "var(--c-primary)", // #018937
        "sf-c-primary-base": "var(--c-primary-base)", // #018937
        ...
        "sf-c-success": "var(--c-success)", // #018937
        "sf-c-success-base": "var(--c-success-base)", // #018937
      ...
      boxShadow: {
        primary: "0 25px 50px -12px rgba(114, 212, 139, 0.3)",
      },
      fontFamily: {
