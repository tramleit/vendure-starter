  ...
  <div id="product">
    ...
    <div class="product">
      <LazyHydrate when-idle>
        ...
        />
        <div v-else class="product__gallery">
          <div v-for="(image, i) in productGallery" :key="i">
            <SfImage :src="image.desktop.url" :alt="image.alt" loading="lazy" />
          </div>
        </div>
      </LazyHydrate>
      ...
      <div class="product__info">
        ...
        <div>
          ...
          <SfAddToCart
            ...
            @click="addToCart"
          >
            <!-- <template #add-to-cart-btn>Thêm vào giỏ hàng</template> -->
          </SfAddToCart>
        </div>
...
export default {
  ...
  setup(props, context) {
    ...
    console.log("facets", product.value.facetValues);
...
.product {
  ...
  &__info {
    ...
    @include for-desktop {
      @apply sticky top-0 max-h-screen overflow-y-auto;
      max-width: 32.625rem;
      margin: 0 0 0 7.5rem;
    }
  }
