...
export class initDb1663733443034 implements MigrationInterface {
   ...
   public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "collection" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "isRoot" boolean NOT NULL DEFAULT false, "position" integer NOT NULL, "isPrivate" boolean NOT NULL DEFAULT false, "filters" text NOT NULL, "id" SERIAL NOT NULL, "featuredAssetId" integer, "parentId" integer, "customFieldsShow_in_navbar" boolean DEFAULT false, "customFieldsShow_in_home_page" boolean DEFAULT false, "customFieldsShow_in_list" boolean DEFAULT false, CONSTRAINT "PK_ad3f485bbc99d875491f44d7c85" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "search_index_item" ("languageCode" character varying NOT NULL, "enabled" boolean NOT NULL, "productName" character varying NOT NULL, "productVariantName" character varying NOT NULL, "description" text NOT NULL, "slug" character varying NOT NULL, "sku" character varying NOT NULL, "price" integer NOT NULL, "priceWithTax" integer NOT NULL, "facetIds" text NOT NULL, "facetValueIds" text NOT NULL, "collectionIds" text NOT NULL, "collectionSlugs" text NOT NULL, "channelIds" text NOT NULL, "productPreview" character varying NOT NULL, "productPreviewFocalPoint" text, "productVariantPreview" character varying NOT NULL, "productVariantPreviewFocalPoint" text, "inStock" boolean NOT NULL DEFAULT true, "productInStock" boolean NOT NULL DEFAULT true, "productVariantId" integer NOT NULL, "channelId" integer NOT NULL, "productId" integer NOT NULL, "productAssetId" integer, "productVariantAssetId" integer, CONSTRAINT "PK_6470dd173311562c89e5f80b30e" PRIMARY KEY ("languageCode", "productVariantId", "channelId"))`, undefined);
   ...
   public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_9d631d7bd3d44af50eca535d72"`, undefined);
        await queryRunner.query(`DROP INDEX "public"."IDX_a48502a38aded69d087a8ec08a"`, undefined);
        await queryRunner.query(`DROP TABLE "order_modification_order_items_order_item"`, undefined);
        await queryRunner.query(`DROP INDEX "public"."IDX_8132041a647c28eb27ecc1691f"`, undefined);
        await queryRunner.query(`DROP INDEX "public"."IDX_a568a3d5aa7f237edab624960b"`, undefined);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_7baeecaf955e54bec73f998b0d"`, undefined);
        await queryRunner.query(`DROP INDEX "public"."IDX_7350d77b6474313fbbaf4b094c"`, undefined);
